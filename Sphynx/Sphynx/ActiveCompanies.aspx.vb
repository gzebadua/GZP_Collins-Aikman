Public Partial Class ActiveCompanies
    ...
    Private Sub rblCompanias_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rblCompanias.SelectedIndexChanged
        ...
        sql = "SELECT username,rtrim(RealName) AS Usuario FROM Users WHERE Active="
        ...
        Else
            ...
            Select Case rblCompanias.SelectedValue
                ...
                Case "1"
                    ...
                    lblError.Text = "NO EXISTEN COMPAÑIAS ACTIVAS"

                Case "0"

                    lblError.Text = "NO EXISTEN COMPAÑIAS DESACTIVADAS"
        ...
        For i = 0 To dgCompanies.Items.Count - 1
            ...
            If tchk.Checked Then
                ...
                If rblCompanias.SelectedValue = "1" Then
                    ...
                    sql = "UPDATE Users SET Active='0' WHERE username='" & dgCompanies.DataKeys(i) & "'"

                Else

                    sql = "UPDATE Users SET Active='1' WHERE username='" & dgCompanies.DataKeys(i) & "'"
