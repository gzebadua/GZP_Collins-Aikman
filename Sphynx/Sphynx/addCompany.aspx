<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="addCompany.aspx.vb" Inherits="Sphynx.addCompany" %>
...
<body topmargin="0" leftmargin="0" background="images/background.png">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel id="pnlContent" runat="server" style="z-index: 102; left: 64px; position: absolute; top: 168px">
            ...
            <asp:Label id="lblAddNewCompany" runat="server" Width="384px" Height="16px" CssClass="largelabel"></asp:Label>
            <br />
            <br />
