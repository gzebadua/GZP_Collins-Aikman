Partial Public Class answerSecretQuestion
    ...
    Private Sub btnAnswer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnswer.Click
        ...
        If logRescueAnswerAttempts(Me, getSQLQueryAsString("SELECT suserrescueanswerhash FROM users WHERE susername = '" & Session("providedUsername") & "'"), txtSecretAnswer.Text) = True Then
    ...
    Private Function logRescueAnswerAttempts(ByVal origen As System.Web.UI.Page, ByVal dbrescueanswer As String, ByVal providedanswer As String) As Boolean
