<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="noRight.aspx.vb" Inherits="Sphynx.noRight" %>
...
<head runat="server">
    <title id="PageTitle" runat="server">Sphynx :: Access Denied</title>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
            <ContentTemplate>
		        ...
		        <asp:Panel id="pnlInfo" runat="server" style="z-index: 108; top: 136px; left: 344px; position: absolute; ">
                    ...
                    <br />
			        <asp:Label id="lblNoRight" runat="server" Width="405px" Height="51px" CssClass="largelabel">lblNoRight</asp:Label>
        			
                </asp:Panel>
                
                <asp:Panel id="pnlLnkGoBack" runat="server" style="z-index: 107; top: 320px; left: 616px; position: absolute;">
