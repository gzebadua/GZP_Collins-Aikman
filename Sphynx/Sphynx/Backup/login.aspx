<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="Sphynx.login" %>
    ...
    <form id="form1" runat="server" defaultbutton="btnLogin">
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
            <ContentTemplate>
                ...
                <asp:Panel id="pnlFlags" runat="server" Height="32px" Width="152px" style="z-index: 111; top: 2px; left: 684px; position: fixed;">
			        ...
			        <p>
				        <asp:Repeater id="rptFlags" runat="server">
					        ...
					        <ItemTemplate>
						                <td>
							                <asp:ImageButton id="ibtnFlag" runat="server" CausesValidation="false" CommandName="DS" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "col") %>' ImageUrl='<%# "images/flags/" & DataBinder.Eval(Container.DataItem, "col") & ".png" %>'></asp:ImageButton>
						                </td>
					        </ItemTemplate>
					        <FooterTemplate>
						            </tr>
                ...
                <asp:Panel id="pnlOOSCover" runat="server" Width="736px" Height="315px" style="z-index: 109; top: 176px; left: 16px; position: absolute;"
                Visible="False" BorderStyle="Solid" BorderColor="Navy" BackImageUrl="images/backgrounds/whitePixel.png">
                </asp:Panel>
                
                <asp:Panel id="pnlOOS" runat="server" style="z-index: 110; top: 228px; left: 273px; position: absolute; ">
                    <asp:Label id="lblSystemOut" runat="server" Font-Size="Large" ForeColor="Navy" Font-Bold="True"></asp:Label>
                </asp:Panel>
	            ...
	            <asp:Panel id="pnlReopen" runat="server" Width="10px" style="z-index: 110; bottom: 0px; right: 0px; position: fixed;">
	                <asp:ImageButton ID="imgReopen" runat="server" Visible="false" CausesValidation="false" PostBackUrl="reopen.aspx" ImageUrl="images/backgrounds/transparentPixel.png" />
	            </asp:Panel>
