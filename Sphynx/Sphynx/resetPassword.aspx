        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
            <ContentTemplate>
		        ...
		        <asp:Panel ID="pnlResetPassword" runat="server" Width="600px" style="z-index: 101; position: absolute; top: 200px; left: 180px; text-align:left;">
		            ...
		            <asp:Label id="lblInstructions" runat="server" CssClass="largelabel">Sphynx recommends using different passwords for each site you use.<br /><br />For example, you could create a lasting passphrase by joining two or more meaningful words and capitalizing the first letters:<br /><br />Your username and the name of the site: NickMyers01Sphynx. <br /><br />Or even a phrase from your favorite movie!<br /><br />Now you try it.</asp:Label>
		            <br />
		            <br />
		            <br />
		            <br />
