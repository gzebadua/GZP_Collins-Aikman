<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tos.aspx.vb" Inherits="Sphynx.tos" %>
...
<head runat="server">
    <title id="PageTitle">Terms of Service :: Collins & Aikman's Sphynx</title>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
            <ContentTemplate>
		        ...
		        <asp:Panel id="pnlTOS" runat="server" Width="95%" style="z-index: 105; top: 136px; left: 32px; position: absolute;">
		            <asp:Label id="lblTOS" runat="server" CssClass="smalllabel">TOS</asp:Label>
		        </asp:Panel>
